      ...
      >
        ...
        >
          ...
          <Transition.Child
            ...
            leaveTo="opacity-0translate-y-4 sm:translate-y-0 sm:scale-95"
          >
            <div
              className="inline-block align-bottom bg-white rounded-lg
            px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all
            sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:pb-6"
            >
              <div>
                {selectedFile ? (
                  <img
                ...
                <div className="mt-5 sm:mt-6">
                  ...
                  focus:ring-2  focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-800
                  disabled:cursor-not-allowed disabled:hover:bg-gray-800"
                    onClick={uploadPost}
                  >
